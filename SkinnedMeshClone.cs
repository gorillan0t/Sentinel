...
internal sealed class SkinnedMeshClone : IDisposable
{
    ...
    internal void RebuildBindings()
    {
        ...
        failureCount              = (Object)(object)cloneRenderer.sharedMesh != (Object)null ? cloneRenderer.sharedMesh.blendShapeCount : 0;
        Transform[] bones = sourceRenderer.bones;
        bool        flag  = bones.Length != sourceBones.Length || (Object)(object)sourceRootBone != (Object)(object)sourceRenderer.rootBone;
        int         num   = 0;
        while (!flag && num < bones.Length)
        {
            flag = (Object)(object)bones[num] != (Object)(object)sourceBones[num];
            num++;
        }
        ...
        {
            flag = (Object)(object)bindings[num2].source == (Object)null || (Object)(object)bindings[num2].source.parent != (Object)(object)bindings[num2].parent;
            num2++;
        }
    ...
    private Transform FindMappedBone(Transform arg1)
    {
        ...
        if ((Object)(object)arg1 == (Object)(object)cloneRoot)
        {
            return sourceRoot;
        }
        ...
        if (!boneMap.TryGetValue(arg1, out Transform value))
        {
            ...
            transform.SetParent((Object)(object)val != (Object)null ? val : sourceRoot, false);
            ...
            bindings.Add(new BoneBinding
            {
                    ...
                    clone     = transform,
                    parent    = arg1.parent,
                    copyScale = (Object)(object)val == (Object)null,
            });
    ...
    internal void Synchronize(Matrix4x4 arg1)
    {
        ...
        {
            if (!((Object)(object)binding.source == (Object)null) && !((Object)(object)binding.clone == (Object)null))
            {
        ...
        if ((Object)(object)sourceRenderer.sharedMesh == (Object)(object)cloneRenderer.sharedMesh)
        {
    ...
    internal static void ApplyTransform(Matrix4x4 arg1, Transform arg2, Transform arg3)
    {
        ...
        Vector4   column = val.GetColumn(3);
        arg3.localPosition = new Vector3(column.x, column.y, column.z);
    ...
    public void Dispose()
    {
        foreach (BoneBinding binding in bindings)
        {
            if ((Object)(object)binding.clone != (Object)null && (Object)(object)binding.clone.parent == (Object)(object)sourceRoot)
            {
