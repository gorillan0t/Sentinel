...
public class Notify : MonoBehaviour
{
    ...
    private void AddNotification(string arg1, Color arg2)
    {
        if (hudRoot == null)
        {
        ...
        notificationCard.messageText                         = Theme.Text(val2.transform, "msg", arg1, 0.028f, Theme.White, true);
        ...
        Theme.Panel panel = Theme.Card(val2.transform, "panel", notificationCard.width, 0.062f, new Color(arg2.r, arg2.g, arg2.b, 0.3f), 2990);
        ...
        GameObject val3 = Theme.Quad(val2.transform, "diamond", 0.034f, 0.034f, Theme.Holo(arg2, 2992));
    ...
    private static void SetRendererAlpha(Renderer arg1, float arg2)
    {
        Color color = arg1.sharedMaterial.color;
        color.a                   = arg2;
        arg1.sharedMaterial.color = color;
    }
