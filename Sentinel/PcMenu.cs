...
public sealed class PcMenu : MonoBehaviour
{
    ...
    private void OnDestroy()
    {
        ...
        {
            Object.Destroy((Object)(object)roundedSprite);
        }

        if ((Object)(object)roundedTexture != (Object)null)
        {
            Object.Destroy((Object)(object)roundedTexture);
        }

        if (ownsFontAsset && (Object)(object)fontAsset != (Object)null)
        {
            ...
            if ((Object)(object)fontAsset.material != (Object)null)
            {
                Object.Destroy((Object)(object)fontAsset.material);
            }

            Object.Destroy((Object)(object)fontAsset);
        }

        if ((Object)(object)fallbackFont != (Object)null)
        {
            Object.Destroy((Object)(object)fallbackFont);
        }
    }
    ...
    {
        if (!Manifest.Has("pc_ui") || !PhotonNetwork.InRoom || player == null || player.IsLocal || (Object)(object)Plugin.Ins == (Object)null)
        {
            return;
        }
    ...
    private void BuildUi()
    {
        ...
        try
        {
            ...
            if ((Object)(object)fallbackFont != (Object)null)
            {
                ...
                ownsFontAsset = (Object)(object)fontAsset != (Object)null;
            }
        }
        catch { }
        ...
        canvasRoot.transform.SetParent(this.transform, false);
    ...
    private void RebuildTab()
    {
        ...
        dynamicTexts.RemoveAll(tuple => (Object)(object)tuple.Text == (Object)null || tuple.Text.transform.IsChildOf(contentRoot.transform));
        int num2 = -1;
        hoveredItemIndex  = -1;
        keyboardSelection = -1;
        ...
        switch (currentTab)
        {
            ...
            case 3:
                if (windSettingsOpen)
                {
                    BuildWindSettingsTab();
                }
                else if (customThemeOpen && Manifest.Has("custom_theme"))
                {
                    BuildCustomThemeTab();
                }
                else
    ...
    private void ToggleSelectedPlayerMute()
    {
        ...
        {
            if (!((Object)(object)allScoreboardLine == (Object)null) && allScoreboardLine.linePlayer != null && !(allScoreboardLine.linePlayer.UserId != selectedPlayerId))
            {
                bool flag = allScoreboardLine.mute == 0;
                allScoreboardLine.PressButton(flag, (GorillaPlayerLineButton.ButtonType)3);
                if ((Object)(object)allScoreboardLine.muteButton != (Object)null)
                {
    ...
    private void BuildRoomTab()
    {
        ...
        AddSetting(2, "Time value +250", GameSettings.GetTimeValueLabel, delegate
                                                                         {
        ...
        AddButton(contentRoot.transform, "Leave room", 0f, 350f, 246f, delegate
                                                                       {
                                                                           if ((Object)(object)NetworkSystem.Instance != (Object)null)
                                                                           {
        ...
        AddButton(contentRoot.transform, "Time -250", 530f, 350f, 262f, () => GameSettings.AdjustTimeValue(-250), () => Manifest.Has("time"));
    ...
    private void BuildAppearanceTab()
    {
        ...
        AddButton(contentRoot.transform, "Wind effect settings", 0f, 410f, 300f, () =>
                                                                                 {
                                                                                     windSettingsOpen = true;
                                                                                     RebuildTab();
                                                                                 });
    }

    private void BuildWindSettingsTab()
    {
        statusLabel.text = "Wind is local-only. Heading: 0° = +Z, 90° = +X. Foliage varies by map.";
        AddButton(contentRoot.transform, "Back", 686f, 0f, 106f, () =>
                                                                 {
                                                                     windSettingsOpen = false;
                                                                     RebuildTab();
                                                                 });

        AddSetting(0, "Preset", WindEffect.PresetName, WindEffect.CyclePreset);
        AddWindStep(1, "Strength",      WindEffect.StrengthName,  () => WindEffect.ChangeStrength(-0.1f), () => WindEffect.ChangeStrength(0.1f));
        AddWindStep(2, "Direction",     WindEffect.DirectionName, () => WindEffect.Rotate(-45),           () => WindEffect.Rotate(45));
        AddWindStep(3, "Particles",     WindEffect.DensityName,   () => WindEffect.StepDensity(-1),       () => WindEffect.StepDensity(1));
        AddWindStep(4, "Particle size", WindEffect.SizeName,      () => WindEffect.StepSize(-1),          () => WindEffect.StepSize(1));
        AddWindStep(5, "Wind volume",   WindEffect.VolumeName,    () => WindEffect.StepVolume(-1),        () => WindEffect.StepVolume(1));
        AddButton(contentRoot.transform, "Audio: " + (Cfg.WindAudio.Value ? "On" : "Off"), 0f, 396f, 246f, () =>
                                                                                                           {
                                                                                                               Cfg.WindAudio.Value = !Cfg.WindAudio.Value;
                                                                                                               RebuildTab();
                                                                                                           });

        AddButton(contentRoot.transform, "Fog: " + (Cfg.WindFog.Value ? "On" : "Off"), 265f, 396f, 246f, () =>
                                                                                                         {
                                                                                                             Cfg.WindFog.Value = !Cfg.WindFog.Value;
                                                                                                             RebuildTab();
                                                                                                         });

        AddButton(contentRoot.transform, "Foliage: " + (Cfg.WindFoliage.Value ? "On" : "Off"), 530f, 396f, 262f, () =>
                                                                                                                 {
                                                                                                                     Cfg.WindFoliage.Value = !Cfg.WindFoliage.Value;
                                                                                                                     RebuildTab();
                                                                                                                 });

        AddDynamicText(() => WindEffect.Status, 0f, 477f, 790f, 24f);
    }

    private void AddWindStep(int row, string label, Func<string> value, Action decrease, Action increase)
    {
        float y = 88f                               + row * 49f;
        AddText(contentRoot.transform, label, 2f, y + 4f, 377f, 32f, 16f, Color.white);
        AddButton(contentRoot.transform, "−", 396f, y, 52f, decrease);
        AddDynamicText(value, 458f, y + 4f, 270f, 32f);
        AddButton(contentRoot.transform, "+", 740f, y, 52f, increase);
    }
    ...
    private void BuildStreamChatTab()
    {
        ...
        AddButton(contentRoot.transform, "Floating chat: " + FloatingChat.ModeName(), 0f, 433f, 380f, () =>
                                                                                                      {
                                                                                                          FloatingChat.Cycle();
                                                                                                          RebuildTab();
                                                                                                      });

        AddButton(contentRoot.transform, "Recenter display", 398f, 433f, 380f, () =>
                                                                               {
                                                                                   if (Cfg.ChatHud.Value == 0) Cfg.ChatHud.Value = 1;
                                                                                   FloatingChat.Recenter();
                                                                               });
    ...
    private void RefreshValues()
    {
        ...
        {
            if ((Object)(object)item.Text != (Object)null)
            {
        ...
        if (actionStatus.Length > 0 && (Object)(object)statusLabel != (Object)null)
        {
    ...
    private static VRRig FindRigByUserId(string arg1)
    {
        ...
        {
            if ((Object)(object)activeRigContainer.Rig != (Object)null && activeRigContainer.Rig.Creator != null && activeRigContainer.Rig.Creator.UserId == arg1)
            {
    ...
    {
        if (!((Object)(object)arg1.Text == (Object)null))
        {
